...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1937.0485; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1937.0485; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2189.707; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public ThreeDeadWheelLocalizer(HardwareMap hardwareMap, double inPerTick, Pose2d initialPose) {
        ...
        // Reverse the direction one the encoders
